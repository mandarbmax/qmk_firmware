 ...
 * +---+---+---+---+---+  +---+---+---+---+---+  +---+---+---+---+  +---+-------+  +---+---+---+---+
 *    +---+---+---+---+---+---+---+---+---+---+---+---+---+------+  +---+---+---+  +---+---+---+---+
 *    | ` | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 0 | - | = |Bspace|  |Fin|Ins|Rem|  |PF1|PF2|PF3|PF4|
 *    +-----------------------------------------------------------  +-----------+  +---------------+
 *    | Tab | Q | W | E | R | T | Y | U | I | O | P | [ | ] |Retn|  |Sel|Prv|Nxt|  | 7 | 8 | 9 | - |
 * +---------------------------------------------------------+   |  +-----------+  +---------------+
 ...
 */
  ...
  [0] = LAYOUT(
    ...
    KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_BSPACE, KC_FIND, KC_INSERT, KC_DELETE, KC_F21, KC_F22, KC_F23, KC_F24, \
    ...
    KC_LGUI, KC_LALT, KC_SPACE, KC_RALT, KC_RGUI, KC_KP_0, KC_KP_DOT \
  )
} ;
