 ...
 *  +--------------------------------------------------------------++   +---+---+---+---+---+
 *  | TAB | Q | W | E | R | T | Y | U | I | O | P | [ | ] |    |LF |    |   | 7 | 8 | 9 | - |
 * ++-----------------------------------------------------|    |---+    |TAB|---------------+
 * |CTL|LCK| A | S | D | F | G | H | J | K | L | ; | ' |RETURN |BRK|    |   | 4 | 5 | 6 | , |
 * +---------------------------------------------------------------+    +-------------------+
 * |BTB|SHIFT| Z | X | C | V | B | N | M | , | . | / |SHIFT|UP |DEL|    |CE | 1 | 2 | 3 |ENT|
 * +---------------------------------------------------------------+    +---------------|   |
 * |PRT|FCN|                                       |HOM|LFT|DWN|RGT|    |00 |   0   | . |   |
 * +---+---+---------------------------------------+---+---+---+---+    +---+-------+---+---+
 */
  ...
  [0] = LAYOUT_116535_RAW(
    ...
    KC_NO, KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RSHIFT, KC_UP, KC_DELETE, KC_CLEAR, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_ENTER, \
    KC_PSCREEN, KC_LALT, KC_SPACE, KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO, KC_KP_0, KC_KP_DOT \
  )
} ;
